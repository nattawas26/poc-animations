...
import { NewsDetailRoot } from '@/components/modules/news-detail/root'
...
export default async function NewsDetail({ params }: PageProps) {
  ...
  return (
    <NewsDetailRoot>
      <article>
        <section className="fixed size-full h-dvh">
          <Image
            src={data.cover}
            alt={data.title}
            fill
        ...
        <div className="relative bg-white min-h-dvh pb-[27.75rem]">
